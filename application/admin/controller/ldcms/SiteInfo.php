    ...
    public function index()
    {
            ...
            if ($params) {
                foreach ($config as $k => &$v) {
                    if (isset($params[$v['name']])) {
                        if (in_array($v['type'], ['array','array3','array4'])) {
        ...
        if (is_array($config)) {
            foreach ($config as $index => $item) {
                ...
                if (in_array($item['type'], ['array','array3','array4'])) { /*如果是数组，将值赋给content*/
    ...
    public function add()
    {
        if ($this->request->isPost()) {
            ...
            if ($params) {
                ...
                if (in_array($params['type'], ['select', 'selects', 'checkbox', 'radio', 'array','array3','array4'])) {
